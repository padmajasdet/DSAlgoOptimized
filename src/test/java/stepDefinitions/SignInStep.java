...
public class SignInStep {
	...
	public SignInStep(TextContextSetup textcontextsetup) {
		...
		this.sip = textcontextsetup.pageobjectmanager.getSigninpage();// object is created inside constructor and called
																		// across all methods
	}
